...
fn: function (aString){
var self=this;
smalltalk.send(self, "_with_", [aString]);
return self;},
args: ["aString"],
source: unescape('text%3A%20aString%0A%09self%20with%3A%20aString.'),
messageSends: ["with:"],
referencedClasses: []
}),
smalltalk.HTMLCanvas);
...
smalltalk.addMethod(
unescape('_append_as_'),
smalltalk.method({
selector: unescape('append%3Aas%3A'),
category: 'adding',
fn: function (anObject, aParameter){
var self=this;
smalltalk.send(anObject, "_appendToBrush_as_", [self, aParameter]);
return self;},
args: ["anObject", "aParameter"],
source: unescape('append%3A%20anObject%20as%3A%20aParameter%0A%20%20%20%20anObject%20appendToBrush%3A%20self%20as%3A%20aParameter'),
messageSends: ["appendToBrush:as:"],
referencedClasses: []
}),
smalltalk.TagBrush);
...
return self;},
args: ["attribute"],
source: unescape('data%3A%20attribute%0A%09%5E%20self%20asJQuery%20data%3A%20attribute'),
...
var self=this;
smalltalk.send(self, "_at_put_", [smalltalk.send(unescape("data-"), "__comma", [attribute]), aString]);
return self;},
args: ["attribute", "aString"],
source: unescape('data%3A%20attribute%20with%3A%20aString%0A%09self%20at%3A%20%27data-%27%2C%20attribute%20put%3A%20aString'),
...
return self;},
args: ["aString"],
source: unescape('frameborder%3A%20aString%0A%09self%20at%3A%20%27frameborder%27%20put%3A%20aString'),
messageSends: ["at:put:"],
referencedClasses: []
}),
smalltalk.TagBrush);
...
unescape('_with_as_'),
smalltalk.method({
selector: unescape('with%3Aas%3A'),
category: 'adding',
fn: function (anObject, aParameter){
var self=this;
smalltalk.send(self, "_append_as_", [anObject, aParameter]);
return self;},
args: ["anObject", "aParameter"],
source: unescape('with%3A%20anObject%20as%3A%20aParameter%0A%20%20%20%20self%20append%3A%20anObject%20as%3A%20aParameter.'),
messageSends: ["append:as:"],
referencedClasses: []
}),
smalltalk.TagBrush);
...
smalltalk.addMethod(
unescape('_appendToBrush_as_'),
smalltalk.method({
selector: unescape('appendToBrush%3Aas%3A'),
category: 'adding',
fn: function (aTagBrush, aParameter){
var self=this;
smalltalk.send(self, "_appendToJQuery_as_", [smalltalk.send(aTagBrush, "_asJQuery", []), aParameter]);
return self;},
args: ["aTagBrush", "aParameter"],
source: unescape('appendToBrush%3A%20aTagBrush%20as%3A%20aParameter%0A%20%20%20%20self%20appendToJQuery%3A%20aTagBrush%20asJQuery%20as%3A%20aParameter'),
messageSends: ["appendToJQuery:as:", "asJQuery"],
referencedClasses: []
}),
smalltalk.Widget);
...
smalltalk.addMethod(
unescape('_appendToJQuery_as_'),
smalltalk.method({
selector: unescape('appendToJQuery%3Aas%3A'),
category: 'adding',
fn: function (aJQuery, aParameter){
var self=this;
smalltalk.send(self, "_renderOn_as_", [smalltalk.send((smalltalk.HTMLCanvas || HTMLCanvas), "_onJQuery_", [aJQuery]), aParameter]);
return self;},
args: ["aJQuery", "aParameter"],
source: unescape('appendToJQuery%3A%20aJQuery%20as%3A%20aParameter%0A%20%20%20self%20renderOn%3A%20%28HTMLCanvas%20onJQuery%3A%20aJQuery%29%20as%3A%20aParameter'),
messageSends: ["renderOn:as:", "onJQuery:"],
referencedClasses: ["HTMLCanvas"]
}),
smalltalk.Widget);
...
smalltalk.addMethod(
unescape('_renderOn_as_'),
smalltalk.method({
selector: unescape('renderOn%3Aas%3A'),
category: 'rendering',
fn: function (html, aParameter){
var self=this;
smalltalk.send(self, "_renderOn_", [html]);
return self;},
args: ["html", "aParameter"],
source: unescape('renderOn%3A%20html%20as%3A%20aParameter%0A%20%20%20%20self%20renderOn%3A%20html'),
